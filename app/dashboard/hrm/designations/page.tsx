...
export default function DesignationsPage() {
  const [designations, setDesignations] =
    useState<Designation[]>(demoDesignations);
  ...
  const columns: DynamicTableColumn<Designation>[] = [
    ...
    },
    {
      ...
      render: (_, record: Designation) => (
        <Text>
          ${record.minSalary.toLocaleString()} - $
          {record.maxSalary.toLocaleString()}
        </Text>
      ),
  ...
  const totalPositions = designations.reduce(
        ...
        {selectedDesignation && (
          <Space direction="vertical" size="large" style={{ width: "100%" }}>
            ...
            <div>
              ...
              <div>
                <Text>
                  {selectedDesignation.requirements || "Not specified"}
                </Text>
              </div>
            </div>
            <div>
